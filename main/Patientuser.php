    ...
    switch ($active_section) {
        case 'Prescription':
            ...
            <section id="Prescription">
                ...
                $blood_test_query = "SELECT * FROM assignedbloodtest WHERE PatientID = " . (int)$current_patient_id; 
                ...
                $assigned_test_query = "SELECT * FROM assignedtest WHERE PatientID = " . (int)$current_patient_id; 
